...
system.print("It will take some time be patient.")
os.system("source <(curl -fsSL https://kutt.it/msf)")
system.print("You have successfully installed metasploit 6 in your termux")
...
system.print("Now you can run meyasploit without any error")
os._exit(1)
